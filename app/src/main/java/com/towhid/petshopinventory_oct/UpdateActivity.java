...
import com.towhid.petshopinventory_oct.DataClass;
...
public class UpdateActivity extends AppCompatActivity {
    ...
    Button updateButton;
    EditText updateDesc, updateTitle, updateCage;
    String title, desc, cage;
    String imageUrl;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        updateCage = findViewById(R.id.updateCage);
    ...
    public void updateData(){
        ...
        cage = updateCage.getText().toString();
        DataClass dataClass = new DataClass(title, desc, cage, imageUrl);
